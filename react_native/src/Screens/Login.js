...
class LoginScreen extends React.Component {
	...
	doLogin = async () => {
		...
		try {
			...
			let data = {balance:{atri:23,btc:0.3,eth:1,ltc:3,bch:1,sum:85}};
			this.props.authSetUserInfo(data);
			...
			<View style={styles.containerlogin100}>
				<View style={{width:390,backgroundColor:'black'}}>
						...
						<View style={{height: '80%', justifyContent: 'center', alignSelf: 'center', alignItems: 'center'}}>
							<View style={{padding:30, backgroundColor:'white', borderRadius:20, width:'100%'}}>
								...
								<View style={{flex:1,flexDirection:'row',marginBottom:70}}>
									<View style={{marginRight:10}}>
										<Icon name="mail-outline" style={{marginTop:13}} size={25} color="black" />
									</View>
									<View style={{width:'95%'}}>
										<TextInput
								...
								<View style={{flex:1, flexDirection:'row', marginBottom:70}}>
									<View style={{marginRight:10}}>
										<Icon name="lock-closed-outline" size={25} color="black" style={{marginTop:15}} />
				...
				<Modal
					...
					<View style={{ backgroundColor:'white',borderRadius:10}}>
						...
						{/* <Image source={{uri: '../Assets/logo.gif'}} /> */}
